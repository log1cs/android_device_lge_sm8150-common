...
BOARD_SUPER_PARTITION_PRODUCT_DEVICE_SIZE := 2147483648
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 1782579200
BOARD_SUPER_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_PRODUCT_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE))
...
include vendor/hardware/lge/sepolicy/SEPolicy.mk
